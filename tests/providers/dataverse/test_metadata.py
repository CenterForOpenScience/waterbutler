...
class TestFileMetadata:
    ...
    def test_file_metadata(self, file_metadata_object):
        ...
        extra = {
            'fileId': file_metadata_object.file_id,
            'datasetVersion': file_metadata_object.dataset_version,
            'hasPublishedVersion': file_metadata_object.has_published_version,
            'hashes': {
                'md5': file_metadata_object.raw['md5'],
            },
        }
