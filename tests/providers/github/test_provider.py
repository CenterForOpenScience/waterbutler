...
def other_credentials():
    return {'token': 'ill have you know that I don\'t take naps. I was just resting my eyes'}
...
class TestCreateFolder:
    ...
    async def test_already_exists(self, provider):
        ...
        assert e.value.message == ('Cannot create folder "Imarealboy"'
        ' because a file or folder already exists at path "/Imarealboy/"')
