...
from waterbutler.providers.figshare.metadata import FigshareFolderMetadata
from waterbutler.providers.figshare.metadata import FigshareFileRevisionMetadata
...
class TestFigshareFileMetadata:
        ...
        assert data.json_api_serialized('cn42d') == {
            ...
            'links': {
                'move': ('http://localhost:7777/v1/resources/cn42d/'
                    'providers/figshare/4037952/6530715'),
                'upload': ('http://localhost:7777/v1/resources/cn42d/'
                    'providers/figshare/4037952/6530715?kind=file'),
    ...
    def test_metadata_article_identifier(self, root_provider_fixtures):
        item = root_provider_fixtures['file_article_metadata']
        article_metadata = FigshareFileMetadata(
            item,
            item['files'][0]
        )
    ...
    def test_folder_metadata(self, root_provider_fixtures):
        ...
        assert data.json_api_serialized('45hjnz') == {
            ...
            'links': {
                'move': ('http://localhost:7777/v1/resources/45hjnz/'
                    'providers/figshare/4040019/'),
                'upload': ('http://localhost:7777/v1/resources/45hjnz/'
                    'providers/figshare/4040019/?kind=file'),
                'delete': ('http://localhost:7777/v1/resources/45hjnz/'
                    'providers/figshare/4040019/'),
                'new_folder': ('http://localhost:7777/v1/resources/'
                    '45hjnz/providers/figshare/4040019/?kind=folder')
            }
        }

        assert data._json_api_links('45hjnz') == {
            'move': 'http://localhost:7777/v1/resources/45hjnz/providers/figshare/4040019/',
            'upload': ('http://localhost:7777/v1/resources/45hjnz/'
                'providers/figshare/4040019/?kind=file'),
            'delete': 'http://localhost:7777/v1/resources/45hjnz/providers/figshare/4040019/',
            'new_folder': ('http://localhost:7777/v1/resources/45hjnz/'
                'providers/figshare/4040019/?kind=folder')
        }
