...
from tests.providers.figshare.fixtures import crud_fixtures, error_fixtures, root_provider_fixtures
...
from waterbutler.providers.figshare.settings import MAX_PAGE_SIZE, PRIVATE_IDENTIFIER
