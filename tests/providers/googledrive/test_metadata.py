...
def test_file_metadata_drive(basepath):
    ...
    assert parsed.extra == {'revisionId': item['version'], 'sourceUrl': item['alternateLink']}
...
def test_file_metadata_docs(basepath):
    ...
    assert parsed.extra == {'revisionId': item['version'], 'downloadExt': '.docx', 'sourceUrl': item['alternateLink']}
