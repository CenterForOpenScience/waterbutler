...
class TestValidatePath:
    ...
    async def test_revalidate_path_file(self, provider, root_provider_fixtures):
        ...
        aiohttpretty.register_json_uri('GET', url, body=root_provider_fixtures['revalidate_path_file_metadata_1'])

        url = provider.build_url('files', file_id, fields='id,title,mimeType')
        aiohttpretty.register_json_uri('GET', url, body=root_provider_fixtures['revalidate_path_file_metadata_2'])
    ...
    async def test_revalidate_path_folder(self, provider, root_provider_fixtures):
        ...
        url = provider.build_url('files', file_id, 'children', q=query, fields='items(id)')
        aiohttpretty.register_json_uri('GET', url, body=root_provider_fixtures['revalidate_path_folder_metadata_1'])

        url = provider.build_url('files', file_id, fields='id,title,mimeType')
        aiohttpretty.register_json_uri('GET', url, body=root_provider_fixtures['revalidate_path_folder_metadata_2'])
...
class TestDelete:
    ...
    async def test_delete_root(self, provider, root_provider_fixtures):
        ...
        aiohttpretty.register_json_uri('GET', url, body=root_provider_fixtures['delete_contents_metadata'])
...
class TestMetadata:
    ...
    * revision parameter: non, valid, invalid, and magic
    ...
    async def test_metadata_file_root(self, provider, root_provider_fixtures):
        path = WaterButlerPath('/birdie.jpg', _ids=(provider.folder['id'], root_provider_fixtures['list_file']['items'][0]['id']))

        list_file_url = provider.build_url('files', path.identifier)
        aiohttpretty.register_json_uri('GET', list_file_url, body=root_provider_fixtures['list_file']['items'][0])

        result = await provider.metadata(path)

        expected = GoogleDriveFileMetadata(root_provider_fixtures['list_file']['items'][0], path)
        assert result == expected
    ...
    async def test_metadata_root_folder(self, provider, root_provider_fixtures):
        ...
        aiohttpretty.register_json_uri('GET', list_file_url, body=root_provider_fixtures['list_file'])
...
class TestRevisions:
    ...
    async def test_get_revisions(self, provider, revision_fixtures, root_provider_fixtures):
        ...
        aiohttpretty.register_json_uri('GET', revisions_url, body=revision_fixtures['revisions_list'])
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_get_revisions_no_revisions(self, provider, revision_fixtures, root_provider_fixtures):
        item = root_provider_fixtures['list_file']['items'][0]
        ...
        aiohttpretty.register_json_uri('GET', revisions_url, body=revision_fixtures['revisions_list_empty'])
...
class TestCreateFolder:
    ...
    async def test_returns_metadata(self, provider, root_provider_fixtures):
        ...
        aiohttpretty.register_json_uri('POST', provider.build_url('files'), body=root_provider_fixtures['folder_metadata'])
...
class TestIntraFunctions:
    ...
    async def test_intra_move_file(self, provider, root_provider_fixtures):
        ...
        dest_path = WaterButlerPath('/really/unsure.txt', _ids=(provider.folder['id'], item['id'], item['id']))
    ...
    async def test_intra_move_folder(self, provider, root_provider_fixtures):
        ...
        dest_path = WaterButlerPath('/really/unsure/', _ids=(provider.folder['id'], item['id'], item['id']))
...
class TestOperationsOrMisc:
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_revalidate_path_file_error(self, provider, root_provider_fixtures, error_fixtures):
        ...
        url = provider.build_url('files', provider.folder['id'], 'children', q=query, fields='items(id)')
        aiohttpretty.register_json_uri('GET', url, body=error_fixtures['parts_file_missing_metadata'])
