...
from tests.providers.osfstorage.fixtures.fixtures import (
    auth,
    credentials,
    settings,
    provider,
...
class TestDelete:
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_delete_folder_contents(self,
                                          provider,
                                          file_path,
                                          folder_path,
                                          folder_children_metadata,
        ...
        children_url, params = build_signed_url_without_auth(provider,
                                                             'GET',
...
class TestUploads:
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_upload_new(self,
                              monkeypatch,
                              provider_and_mock,
                              file_stream,
                              upload_response,
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_upload_existing(self,
                                   monkeypatch,
                                   provider_and_mock,
                                   file_stream,
                                   upload_path,
    ...
    @pytest.mark.asyncio
    @pytest.mark.aiohttpretty
    async def test_upload_catch_non_404_errors(self,
                                               monkeypatch,
                                               provider_and_mock,
                                               file_stream,
                                               upload_path,
