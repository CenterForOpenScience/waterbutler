...
ONEDRIVE_RESUMABLE_UPLOAD_CHUNK_SIZE = config.get('ONEDRIVE_RESUMABLE_UPLOAD_CHUNK_SIZE', 1024 * 1024 * 10) # 10mb
ONEDRIVE_RESUMABLE_UPLOAD_FILE_SIZE = config.get('ONEDRIVE_RESUMABLE_UPLOAD_FILE_SIZE', 1024 * 1024 * 90) # 90mb
